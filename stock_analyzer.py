...
import yfinance as yf  # For news only, or switch to Polygon if preferred
import os
from textblob import TextBlob

# ===================== CONFIG =====================
# Updated S&P 500 tickers as of December 27, 2025 (from previous refinements)
tickers = [
...
DISCORD_TOKEN = "MTQ1Mjk1MzgxNTYwNjIzMTE3Nw.GotfnW.gi5gXBdG6mwNDH0Ke9vePRcaeFRMS4wQZ3FCAQ"
POLYGON_API_KEY = "5JGzxdk3phVCv9X55p80zTVcHguu2hEd"
CHANNEL_ID = 1452953815606231177
DISCORD_TOKEN = os.getenv("DISCORD_TOKEN")
POLYGON_API_KEY = os.getenv("POLYGON_API_KEY")
CHANNEL_ID = int(os.getenv("CHANNEL_ID", "1452952904980758571"))
>>>>>>> 6914ffbba1040e8d92ec9fe0b2ee952f3a13e50d
...
def get_stock_news(ticker: str) -> str:
    try:
        ...
        news = stock.news[:5]  # Top 5 recent
        if not news:
...
async def schedule_daily():
    while True:
        ...
        if weekday in [6, 0, 1, 2, 3] and hour in [6, 7, 8, 9, 10]:  # Dubai: Sun-Thu, 06:00-11:00 UTC
            await daily_analysis()
        # Sleep until next potential scan (check every minute for precision)
